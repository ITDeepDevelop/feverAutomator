...
public class ExcelPage extends BorderPane {
    ...
    public ExcelPage() {
        ...
        header.setStyle("-fx-background-color: linear-gradient(to right, #3498db, #2980b9); -fx-background-radius: 8;");
        this.setTop(header);
        ...
        // Contenitore bottoni
        HBox buttonBox = new HBox(15, loadButton, clearButton);
    ...
    private void stylePrimaryButton(Button button) {
        button.setStyle(
            "-fx-background-color: #2980b9; -fx-text-fill: white; -fx-font-size: 12px; -fx-font-weight: bold;" +
            "-fx-padding: 10 20; -fx-background-radius: 8;"
        );
        button.setMinWidth(160);
        button.setOnMouseEntered(e -> button.setStyle(
            "-fx-background-color: #3498db; -fx-text-fill: white; -fx-font-size: 12px; -fx-font-weight: bold;" +
            "-fx-padding: 10 20; -fx-background-radius: 8;"
        ));
    ...
    private void styleDangerButton(Button button) {
        button.setStyle(
            "-fx-background-color: #c0392b; -fx-text-fill: white; -fx-font-size: 12px; -fx-font-weight: bold;" +
            "-fx-padding: 10 20; -fx-background-radius: 8;"
        );
        button.setMinWidth(160);
        button.setOnMouseEntered(e -> button.setStyle(
            "-fx-background-color: #e74c3c; -fx-text-fill: white; -fx-font-size: 12px; -fx-font-weight: bold;" +
            "-fx-padding: 10 20; -fx-background-radius: 8;"
        ));
        button.setOnMouseExited(e -> button.setStyle(
            "-fx-background-color: #c0392b; -fx-text-fill: white; -fx-font-size: 12px; -fx-font-weight: bold;" +
